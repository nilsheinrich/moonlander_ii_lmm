...
close_fixations <- close_fixations[close_fixations$fixation_duration > 0, ]
distant_fixations <- distant_fixations[distant_fixations$fixation_duration > 0, ]
...
```
lambda, the estimated value is closer to 0.5 than to 1, which implies √(x) transformation.
