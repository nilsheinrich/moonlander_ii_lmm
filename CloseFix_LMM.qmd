...
```
m_varyingSlope3 has the same BIC as m_varyingSlope_complex_ni, but lower AIC. Proceeding with m_varyingSlope3.
...
One for **N_visible_obstacles** (0.00506132, 0.0202239), which increases the distance to the spaceship in resting fixations with increasing N of obstacles on screen.
**N_visible_drift_tiles** also increases the distance to the agent (0.00249257, 0.0298237).
**N_visible_drift_tiles** and **block: no_drift** interact negatively with each other (-0.0602347, -0.0119704).
