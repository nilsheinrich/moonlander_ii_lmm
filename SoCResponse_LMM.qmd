...
```
BIC=226.0 vs BIC=219.0, m_varyingInt1 wins.
...
m_varyingSlope_zc_done was the only one that converged. But it still fits worse to the data than m_varyingInt1. We will thus proceed with m_varyingInt1.
...
- level_difficulty:hard (-0.22199, -0.159012)
- No significance for block: fake vs. normal (-0.0767441, 0.00326358)
- block: invisible vs. normal (-0.727074, -0.649873)
- N_fixations (0.00050266, 0.000798721)
- N_consecutive_crash_success (0.0297135, 0.0373815)
