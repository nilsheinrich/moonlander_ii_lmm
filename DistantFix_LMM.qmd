...
m_varyingInt_ = let
    varInt = @formula(√(Dist_to_closest_obstacles) ~  N_visible_drift_tiles * block +
    (1 | ID) +
...
m_varyingSlope_complex = let
    varSlop = @formula(√(Dist_to_closest_obstacles) ~ 1 + N_visible_drift_tiles * block + 
...
We see a single main effect for **N_visible_drift_tiles** (-0.250191, -0.0169198), decreasing the distance to the closest obstacle with increasing N.
